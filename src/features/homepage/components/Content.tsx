    ...
    <section className="w-full  relative overflow-hidden">
      <div className="container mx-auto relative z-10"> 
        ...
        />
            ...
            <h2 className="font-metal text-5xl md:text-6xl text-black relative mb-6 text-center tracking-tight">
              Product Showcase
            </h2>
            ...
            <div className="absolute bottom-2 right-2 font-serif text-xs text-black/40">Page 1</div>
          </div>
        </FadeUp>
