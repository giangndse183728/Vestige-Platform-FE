        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-12 mb-16 border-b border-black/20 pb-16">
          ...
          <div className="md:col-span-4 space-y-6 backdrop-blur-sm bg-white/40 p-6">
            ...
            <div className="pt-2 flex space-x-4">
              <a href="#" aria-label="Instagram" className="h-9 w-9 flex items-center justify-center text-black/80 hover:text-red-900 border border-black/20 hover:border-red-900 backdrop-blur-md bg-white/30">
                <Instagram size={16} />
              </a>
              <a href="#" aria-label="Twitter" className="h-9 w-9 flex items-center justify-center text-black/80 hover:text-red-900 border border-black/20 hover:border-red-900 backdrop-blur-md bg-white/30">
                <Twitter size={16} />
              </a>
              <a href="#" aria-label="Facebook" className="h-9 w-9 flex items-center justify-center text-black/80 hover:text-red-900 border border-black/20 hover:border-red-900 backdrop-blur-md bg-white/30">
                <Facebook size={16} />
              </a>
              <a href="#" aria-label="Email" className="h-9 w-9 flex items-center justify-center text-black/80 hover:text-red-900 border border-black/20 hover:border-red-900 backdrop-blur-md bg-white/30">
                <Mail size={16} />
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-2 backdrop-blur-md bg-white/40 p-4">
            ...
            <div className="space-y-4 mt-6">
              ...
              <div className="space-y-3">
                ...
                />
                <button className="w-full py-2 px-4 bg-black/80 backdrop-blur-sm text-white text-xs tracking-wide uppercase font-gothic font-medium hover:bg-red-900 transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
