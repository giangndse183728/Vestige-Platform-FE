...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-4 text-center">
      ...
      <div className="w-16 h-[1px] bg-red-900 mx-auto mb-6"></div>
      ...
      <Link
        href="/"
        className="px-8 py-3 bg-black text-white font-gothic text-sm uppercase tracking-widest transition-colors duration-300 hover:bg-red-900"
      >
        Return Home
      </Link>
    </div>
